...
<StepTtile title={"개인정보처리방침"} subtitle={"PRIVACY POLICY"} subtitlecolor={"#1292F5"}/>
      <StepNav list={["개인정보처리방침"]}/>
      <div className="w-full items-center  justify-center flex flex-col mt-[5%]">
<section className=" w-full h-full ">
<p>하남시는 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 
다음과 같이 개인정보 처리지침을 수립·공개합니다.</p>
<span>
제1조(개인정보의 처리목적)

• 회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보 보호법 제18조에 따라 별도의 동의를 받는 등 
필요한 조치를 이행할 예정입니다.
...
2. 재화 또는 서비스 제공
- 서비스 제공, 계약서·청구서 발송, 콘텐츠 제공, 본인인증, 요금결제·정산 등을 목적으로 개인정보를 처리합니다.
...
1. 홈페이지 회원 가입 및 관리
- 필수항목 : 성명, 아이디, 비밀번호, 연락처, 이메일주소, 주소, 사업자등록번호

2. 재화 또는 서비스 제공
- 필수항목 : 성명, 연락처, 사업자등록번호, 사업자등록증, 사업장주소, 사업 업종구분
...
2. 파기방법
- 회사는 전자적 파일 형태로 기록·저장된 개인정보는 기록을 재생할 수 없도록 로우레밸포멧(Low Level Format) 등의 방법을 이용하여 파기하며, 종이 문서에 기록·저장된 개인정보는 분쇄기로 분쇄하거나 
소각하여 파기합니다.
...
• 정보주체께서는 회사의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 회사는 정보주체의 
