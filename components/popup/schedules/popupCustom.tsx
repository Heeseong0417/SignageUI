    ...
    isOpen !=="0"&&  (
      ...
      >
        <Dialog
          ...
          className="z-[9999] fixed top-[25%] left-[5%] lg:left-[30%] w-[90%] lg:w-[40%] min-w-[20rem] leading-10  max-w-full p-0 m-0 bg-white rounded-lg shadow-lg flex flex-col overflow-hidden"
